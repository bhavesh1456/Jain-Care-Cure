...
<!-- Document Title -->
<title>Jain Care And Cure Hospital</title>
...
<div id="wrap">
  <div class="top-bar">
    <div class="container">
      <div class="row">
        <div class="col-sm-6">
          <p>Welcome To Jain Care And Cure</p>
        </div>
        <div class="col-sm-6">
  ...
  <header class="header-style-2">
    <div class="container">
      <div class="logo"> <a href="index.html"><img src="images/jain.png" alt="" style="height: 52px;"></a> </div>
      <div class="head-info">
        <ul>
          ...
          <li> <i class="fa fa-envelope-o"></i>
            <p>jainsanjeev@gmail.com<br>
              info@gmail..com</p>
          </li>
          <li> <i class="fa fa-map-marker"></i>
            <p>Bamangaon, Alibag <br>
             </p>
          </li>
        </ul>
      </div>
